...
#define ORIGINAL_FILE_NAME "UE4Editor-VmpcPlugin-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME MyFirstVR
#define _CRT_SECURE_NO_WARNINGS 1
#define BOOST_DISABLE_ABI_HEADERS 1
#define DEPRECATED_FORGAME DEPRECATED
#define _CRT_SECURE_NO_WARNINGS 1
#define BOOST_DISABLE_ABI_HEADERS 1
#define VMPCPLUGIN_API DLLEXPORT
...
#define _CRT_SECURE_NO_WARNINGS 1
#define BOOST_DISABLE_ABI_HEADERS 1
#define WITH_VMPCTHIRDPARTY_BINDING 1
